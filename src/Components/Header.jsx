...
const Header = () => {
  const { handleSearch, handleSubmit, userLocation, inputCity } =
    ...
    <div className="cc py-5 fixed w-screen bg-[var(--bg)] z-50 top-0">
      <div className="container flex md:flex-row flex-col md:items-center gap-5 md:gap-0 justify-between">
        ...
        <div className="container flex items-center justify-between md:w-[65%] w-full">
          <form
            className="flex items-center justify-start bg-[var(--elem)] p-2 gap-2 w-[65%] md:w-[50%] rounded-3xl"
          ...
          <div className="flex items-center justify-center gap-2">
            <div
              className="flex items-center justify-start bg-[var(--btn)] md:py-2 md:px-4 px-3 py-2 gap-2 rounded-3xl cursor-pointer"
              onClick={userLocation}
            >
              <FaLocationCrosshairs className="text-black" />
              <p className="text-black flex gap-2">
                <span className="hidden md:block">Current</span> Location
              </p>
            </div>
          </div>
        </div>
